...
public:
  ...
  void set_orderbook(std::shared_ptr<DepthOrderbooks> orderbook) override;

  std::shared_ptr<DepthOrderbooks> get_orderbook() override;
...
private:
  ...
  std::shared_ptr<DepthOrderbooks> orderbooks_;
};
