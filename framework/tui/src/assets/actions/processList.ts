...
import { ARCHIVE_DIR } from '@kungfu-tech/api/config/pathConfig';
import { globalState } from './globalState';
import {
  LifeCycleHook,
  LifeCycleKeys,
} from '@kungfu-tech/api/hooks/lifeCycleHook';
      ...
      return [
        {
          ...
          category: masterLocation.category,
          group: masterLocation.group,
        ...
        },
        {
          ...
          processName: 'LEDGER',
          typeName: colors.bgMagenta('Sys'),
          category: ledgerLocation.category,
