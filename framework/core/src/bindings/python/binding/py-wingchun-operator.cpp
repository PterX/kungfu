...
void bind_operator(pybind11::module &m) {
  ...
  py::class_<op::Runner, kungfu::yijinjing::practice::apprentice, std::shared_ptr<op::Runner>>(m, "OpRunner")
      ...
      .def("get_begin_time", &op::Runner::get_begin_time)
      .def("get_end_time", &op::Runner::get_end_time)
      ...
      .def("get_home_uid", &op::Runner::get_home_uid)
      .def("get_home_uname", &op::Runner::get_home_uname)
      .def("now", &op::Runner::now)
      .def("run", &op::Runner::run)
      .def("pre_setup", &op::Runner::pre_setup)
      .def("setup", &op::Runner::setup)
      .def("step", &op::Runner::step)
      .def("is_live", &op::Runner::is_live)
