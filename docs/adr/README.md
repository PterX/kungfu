...
| [0134](ADR-0134-layered-api-and-protocol-owned-canonical-encoding.md) | accepted | C++/Node/Python/Rust share one versioned C ABI waist; each Root protocol owns its canonical preimage while Hana POD, FlatBuffers, JSON edges, and opaque bytes retain distinct carrier roles |
