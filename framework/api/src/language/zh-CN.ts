export default {
  ...
  globalSettingConfig: {
    ...
    bypass_cacheD_desc:
      '在此模式下, 交易数据不在会落地到本地关系数据库内, 仅会在内存数据库中保留, 应对特殊场景, 除非明确知道风险, 请勿打开, 重启后生效',
    ...
    low_memory: "低内存模式",
    low_memory_desc: "柜台进程定期清理维护的交易信息缓存, 以减少内存占用, 应对特殊场景, 可能造成前端展示信息错误, 除非明确知道风险, 请勿打开, 开启后重启柜台进程生效",
