...
void bind_book(pybind11::module &m) {
  ...
  py::class_<Book, Book_ptr>(m, "Book")
      ...
      .def_property_readonly("baskets", &Book::get_baskets, py::return_value_policy::reference)
      .def_property_readonly("basket_instruments", &Book::get_basket_instruments, py::return_value_policy::reference)
