...
public:
  ...
  nanomsg::socket_ptr dial_socket(const data::location_ptr &location, const nanomsg::protocol &p, int timeout = 0);

  nanomsg::socket_ptr listen_socket(const nanomsg::protocol &p, int timeout = 0);
