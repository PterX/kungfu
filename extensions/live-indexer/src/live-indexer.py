...
def find_md_slice_location(ctx, nano_time, group, name, instrument_id, exchange_id, data_type):
	slice_location = yjj.location(lf.enums.mode.LIVE, lf.enums.category.MD, group, name, ctx.runtime_locator)
...
def find_operator_slice_location(ctx, nano_time, group, name):
	slice_location = yjj.location(lf.enums.mode.LIVE, lf.enums.category.OPERATOR, group, name, ctx.runtime_locator)
	return slice_location
