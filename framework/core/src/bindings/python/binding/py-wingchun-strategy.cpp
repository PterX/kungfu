...
void bind_strategy(pybind11::module &m) {
  ...
  py::class_<strategy::Runner, PyRunner, kungfu::yijinjing::practice::apprentice, std::shared_ptr<strategy::Runner>>(
      ...
      .def("get_begin_time", &strategy::Runner::get_begin_time)
      .def("get_end_time", &strategy::Runner::get_end_time)
      ...
      .def("get_home_uid", &strategy::Runner::get_home_uid)
      .def("get_home_uname", &strategy::Runner::get_home_uname)
      .def("now", &strategy::Runner::now)
      .def("run", &strategy::Runner::run)
      .def("pre_setup", &strategy::Runner::pre_setup)
      .def("setup", &strategy::Runner::setup)
      .def("step", &strategy::Runner::step)
      .def("is_live", &strategy::Runner::is_live)
