...
async function handleOpenSetTdModal(
  ...
  watch(
    () => extConfigs,
    () => {
      if (!extConfigs.value || !extConfigs.value['td']) {
        marginSupportTdMap = {};
        return;
      }
      Object.keys(extConfigs.value['td']).forEach((key) => {
        extConfigs.value['td'][key]?.margin?.showMargin &&
          (marginSupportTdMap[key] = true);
      });
    },
        ...
        >
            ...
            <KfBlinkNum
              ...
              :num="
                marginSupportTdMap[record.group]
                  ...
                  : dealAssetPrice(getAssetsByTdGroup(record).market_value)
              "
            ></KfBlinkNum>
          </template>
          ...
          <template v-else-if="column.dataIndex === 'frozen_funds'">
            ...
            <KfBlinkNum
              ...
              :num="
                marginSupportTdMap[record.group]
                  ? dealAssetPrice(getAssetsByTdGroup(record).frozen_cash)
                  : '--'
              "
            ></KfBlinkNum>
          </template>
          <template v-else-if="column.dataIndex === 'short_sale_proceeds'">
            ...
            <KfBlinkNum
              ...
              :num="
                marginSupportTdMap[record.group]
                  ? dealAssetPrice(getAssetsByTdGroup(record).short_cash)
                  : '--'
              "
            ></KfBlinkNum>
          </template>
          ...
          <template v-else-if="column.dataIndex === 'avail_margin'">
            ...
            <KfBlinkNum
              ...
              :num="
                marginSupportTdMap[record.group]
                  ? dealAssetPrice(getAssetsByTdGroup(record).avail_margin)
                  : '--'
              "
            ></KfBlinkNum>
          </template>
          <template v-else-if="column.dataIndex === 'total_liabilities'">
            ...
            <KfBlinkNum
              ...
              :num="
                marginSupportTdMap[record.group]
                  ? dealAssetPrice(getAssetsByTdGroup(record).total_debt)
                  : '--'
              "
            ></KfBlinkNum>
          </template>
          <template v-else-if="column.dataIndex === 'equity'">
            ...
            <KfBlinkNum
              ...
              :num="
                marginSupportTdMap[record.group]
                  ? dealAssetPrice(getAssetsByTdGroup(record).net_assets)
                  : '--'
              "
            ></KfBlinkNum>
          </template>
          <template v-else-if="column.dataIndex === 'total_borrowed_funds'">
            ...
            <KfBlinkNum
              ...
              :num="
                marginSupportTdMap[record.group]
                  ? dealAssetPrice(getAssetsByTdGroup(record).long_total_debt)
                  : '--'
              "
            ></KfBlinkNum>
          </template>
          <template v-else-if="column.dataIndex === 'total_short_liabilities'">
            ...
            <KfBlinkNum
              ...
              :num="
                marginSupportTdMap[record.group]
                  ? dealAssetPrice(getAssetsByTdGroup(record).short_total_debt)
                  : '--'
              "
            ></KfBlinkNum>
          </template>
          <template v-else-if="column.dataIndex === 'cash_debt'">
            ...
            <KfBlinkNum
              ...
              :num="
                marginSupportTdMap[record.group]
                  ? dealAssetPrice(getAssetsByTdGroup(record).cash_debt)
                  : '--'
              "
            ></KfBlinkNum>
          </template>
