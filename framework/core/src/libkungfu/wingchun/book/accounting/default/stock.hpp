...
public:
  ...
  protected:
    ...
    static contract_multiplier_and_margin_ratio get_instrument_conversion_margin_rate(
        const Book_ptr &book, uint32_t account_id, longfist::enums::Direction direction, const char *exchange_id,
