...
export const getKfGlobalSettings = (): KfSystemConfig[] => [
  {
    ...
    config: [
      ...
      {
        key: 'keepPage',
        name: t('globalSettingConfig.keep_page'),
        tip: t('globalSettingConfig.keep_page_desc'),
        type: 'bool',
        default: false,
      },
      {
        key: 'preload',
        name: t('globalSettingConfig.preload'),
        tip: t('globalSettingConfig.preload_desc'),
        type: 'bool',
        default: false,
      },
      {
        key: 'bypassAccounting',
        name: t('globalSettingConfig.bypass_accounting1'),
        tip: t('globalSettingConfig.bypass_accounting_desc1'),
        type: 'bool',
        default: false,
      },
      {
        key: 'bypassRefreshBook',
        name: t('globalSettingConfig.bypass_refresh_book'),
        tip: t('globalSettingConfig.bypass_refresh_book_desc'),
        type: 'bool',
        default: false,
      },
      {
        key: 'bypassSyncAsset',
        name: t('globalSettingConfig.bypass_sync_asset'),
        tip: t('globalSettingConfig.bypass_sync_asset_desc'),
        type: 'bool',
        default: false,
      },
      {
        key: 'bypassSyncPosition',
        name: t('globalSettingConfig.bypass_sync_position'),
        tip: t('globalSettingConfig.bypass_sync_position_desc'),
        type: 'bool',
        default: false,
      },
      {
        key: 'maxPreCreateSize',
        name: t('globalSettingConfig.max_pre_create_size'),
        tip: t('globalSettingConfig.max_pre_create_size_desc'),
        type: 'int',
        default: 1,
      },
    ],
