...
void bind_broker(pybind11::module &m) {
  py::class_<BrokerVendor, PyBrokerVendor, std::shared_ptr<BrokerVendor>>(m, "BrokerVendor")
      ...
      .def_property_readonly("home", &BrokerVendor::get_home, py::return_value_policy::reference)
  ...
  py::class_<MarketData, PyMarketData, std::shared_ptr<MarketData>>(m, "MarketData")
      ...
      .def_property_readonly("state", &MarketData::get_state, py::return_value_policy::reference)
      .def_property_readonly("runtime_folder", &MarketData::get_runtime_folder, py::return_value_policy::reference)
      .def_property_readonly("config", &MarketData::get_config, py::return_value_policy::reference)
  ...
  py::class_<Trader, PyTrader, std::shared_ptr<Trader>>(m, "Trader")
      .def(py::init<BrokerVendor &>())
      .def_property_readonly("state", &Trader::get_state, py::return_value_policy::reference)
      .def_property_readonly("runtime_folder", &Trader::get_runtime_folder, py::return_value_policy::reference)
      .def_property_readonly("config", &Trader::get_config, py::return_value_policy::reference)
