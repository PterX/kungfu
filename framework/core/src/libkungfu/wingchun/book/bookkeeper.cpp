...
Bookkeeper::Bookkeeper(apprentice &app, broker::Client &broker_client) : app_(app), broker_client_(broker_client), account_method_type_(book::get_accounting_method_type()) {
